;メッセージレイヤの定義
		...
		[position width=920 height=170 top=420 left=20 ]
		...
		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=26 x=30 y=420 bold="bold" edge="undefined" shadow="undefined"]
		...
		[position layer="message1" width=920 height=170 top=420 left=20 ]
